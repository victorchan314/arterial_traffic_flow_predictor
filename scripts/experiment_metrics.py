...
def main(args):
    ...
    tables = build_metrics_table(experiment_dir, args_dict, should_split_name=split_name, dcrnn_only=dcrnn_only)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--split_name", action="store_true", help="split name to the beginning of each row")
    parser.add_argument("--dcrnn_only", action="store_true", help="print results for DCRNN only")
